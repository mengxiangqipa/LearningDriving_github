...
public class Fragment_2_2_gridview extends Fragment implements View.OnClickListener, GetConstantUtil.CallBack_GetConstant {
    Context mContext;
...
//        initEvent();
    ...
    private void initData() {
        if (TextUtils.isEmpty(PreferencesHelper.getString(ConstantsME.constantUrlList)) && tryCount < 2) {
    ...
    private void getList() {
        String string = PreferencesHelper.getString(ConstantsME.constantUrlList);
        try {
