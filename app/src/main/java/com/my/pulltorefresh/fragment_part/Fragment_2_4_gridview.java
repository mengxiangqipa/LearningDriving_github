...
public class Fragment_2_4_gridview extends Fragment implements View.OnClickListener, GetConstantUtil.CallBack_GetConstant {
    Context mContext;
...
//        initEvent();
    ...
    private void initData() {
        if (TextUtils.isEmpty(PreferencesHelper.getString(ConstantsME.constantUrlListk4)) && tryCount < 2) {
    ...
    private void getList() {
        String string = PreferencesHelper.getString(ConstantsME.constantUrlListk4);
        try {
