...
//        mHeight = Utils.dip2px(context, 12);
    ...
    /**
     *    <pre>
     *     @param //这里返回的TextView，就是我们看到的View
     *     @return
    ...
    public View makeView() {
        ...
        FrameLayout.LayoutParams parmas=new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.WRAP_CONTENT);
        parmas.gravity=Gravity.CENTER;
        TextView t = new TextView(mContext);
        t.setGravity(Gravity.CENTER);
        t.setLayoutParams(parmas);
        t.setTextSize(TypedValue.COMPLEX_UNIT_DIP,mHeight);
        t.setTextColor(getResources().getColor(R.color.gooddream_gray_light));
        t.setSingleLine();
        return t;
    }
